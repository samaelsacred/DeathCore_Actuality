...
if(WITHOUT_GIT)
  set(rev_date "30-01-2017 18:35:00 +7.x.x")
  set(rev_hash "7.x.x")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"7.x.x 30-01-2017 08:35:00 (Arquivado)\"")
    set(rev_date "30-01-2017 08:35:00 +7.x.x")
    set(rev_hash "7.x.x")
    set(rev_branch "Arquivado")
  else()
