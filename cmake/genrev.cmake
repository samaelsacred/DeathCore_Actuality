...
if(WITHOUT_GIT)
  set(rev_date "30-01-2017 18:35:00 +3.3.5a")
  set(rev_hash "3.3.5a")
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"3.3.5a 30-01-2017 08:35:00 (Arquivado)\"")
    set(rev_date "30-01-2017 08:35:00 +3.3.5a")
    set(rev_hash "3.3.5a")
    set(rev_branch "Arquivado")
  else()
